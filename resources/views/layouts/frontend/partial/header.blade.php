                                ...
                                <div onclick="myFunction()">
                                    <button class="dropbtn btn  profileName btncustom ">
                                        @if ($user_photo->picture__input != null)
                                            <img class="me-1 dropbtn"
                                                src="{{ asset('uploads/userImage/' . $user_photo->picture__input) }}"
                                                ...
                                                <form method="POST" action="{{ route('logout') }}">
                                                    ...
                                                    <a class="user-menu-link fw-bold" href="#" style="color: #F44336;"
                                                        onclick="event.preventDefault(); this.closest('form').submit();"><i
                                                            class="bi bi-box-arrow-right pe-2 fw-bold"></i>
                                                        {{ __('messages.Signout') }}</a>
                                                </form>
                                            </li>
                            ...
                            <div class=" dropdown">
                                <a href="#" class="dropdown-toggle nav-link  align-items-center d-flex"
                                    ...
                                    <svg style="height: 25px; width: 25px">
                                        <circle cx="10" cy="11" r="7" stroke="green" stroke-width="5" fill="red" />
                                    </svg>
                                </div> --}}
                    ...
                    @guest
                        ...
                        <li class="nav-item d-flex align-items-center">
                            <a class="nav-link p-1" aria-current="page"
                                href="{{ route('login') }}">{{ __('messages.Signin') }}</a>
                        </li>
                        <li class="nav-item d-flex align-items-center">
                            <svg height="50" width="3">
                                <line x1="0" y1="15" x2="0" y2="40"
                        ...
                        <li class="nav-item d-flex align-items-center">
                            <a class="nav-link p-1" aria-current="page"
                                href="{{ route('create') }}">{{ __('messages.CreateBill') }}</a>
                        </li>
                    @endguest
