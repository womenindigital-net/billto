...
<div class="page  "
    style=" background-image:  url('{{ asset('assets/vector-invoice/vector15.png') }}'); background-repeat: no-repeat;">
            ...
            <div class="row">
                ...
                <div class="col-9 ">
                    <div class="d-flex justify-content-end me-5">
                        <h1 style="background-color: #0072BC; color: #ffffff; padding:10px; font-size:50.99px;">
        ...
        <section class="second_section">
            <div class="row">
                ...
                <div class="col-4 mb-4">
                    <h5 class="p-0 m-0" style="border-bottom:1px solid #0072BC; color: #0072BC;">
        ...
        <section class="four_section">
            <div class="row">
                ...
                <div class="col-10 ">
                    ...
                    <div class="p-0" style=" margin-top:50px; color: #CBF1FF; background-color:#CBF1FF;">
                        <p class="p-0 m-0" style="border:1px solid #CBF1FF;"></p>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-end fw-bold border-0 "
                                            style="background-color: #0072BC; color:#F2F2F2">{{ __('messages.Total') }} </td>
                                        <td class="text-end fw-bold border-0 pe-5 "
                                            style="background-color: #0072BC;color:#F2F2F2">   {{ number_format($data->final_total - $data->receive_advance_amount, 2) }}</td>
                                    </tr>
                                </tbody>
                            </table>
