...
<body>
    ...
    <body>
        ...
        <div class="invoice_body page" size="A4"  style="background:url('assets/vector-invoice/vector3.png');">
            <section class="first_section">
                <img src="{{ asset('assets/vector-invoice/vector3.png') }}" alt="">
                ...
                <div class="heading_area" style="color: #686868;">
                    ...
                    <div class="i_title">
                        <img src="img/logo.png" alt="img" style="width: 70px">
                        <h1>INVOICE</h1>
                    </div>
            ...
            <section class="third_section">
                ...
                <div class="right_Side_bar" style="margin-top: 70px;">

                        <div class="f">
                            <div class="thanks">
                                <h5 style="color: #686868; font-weight: 400; font-size: 18px; padding-bottom:37px; width: 80%">Thank You for your business</h5>
                            </div>
