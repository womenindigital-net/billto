        ...
        <div class="custom_border_lr">
                ...
                <div class="second_section_invoice_to_date">
                    <div class="section_invoice_to" >
                        <div class="invoice_two_details">
                            ...
                            <p style="border-bottom:2px solid #FF0000; padding:2px 0px; margin:0px; width:90%;"></p>
                    ...
                    <div class="col-12" style="margin-left: 50px; margin-right:30px; padding-top:20px;">
                        <table class="table table-bordered  border border-white mb-0">
                            ...
                            <tr>
                                ...
                                <th
                                    style="  background: #FF0000;   padding-right:20px; text-align:right; width:22.3%;   font-size: 17px;text-transform: uppercase; color: #fff;">
                            ...
                            @foreach ($productsDatas as $product_detail)
                                <tr>
                                    ...
                                    <td
                                        style="border-collapse: collapse;   padding-right:20px;   font-weight: 400; font-size: 16px; color: #fff; text-align:right; background: #FF0000;">
                            ...
                            @for ($x = $last_count; $x <= 5; $x++)
                                <tr>
                                    ...
                                    <td
                                        style="border-collapse: collapse;  padding-right:20px;    font-size: 16px; color: #fff; text-align:right; background: #FF0000;">
                                    </td>
                                </tr>
                            @endfor
                        </table>
                ...
                <div class="row m-0 p-0">
                    ...
                    <div class="  col-3 ms-0 ps-0">
                        <div class="col_40">
                            ...
                            <p style="padding:4px 0; margin:0px; color:#fff;"> {{ number_format($data->discount_amounts, 2) }}
                            </p>
                            <p style="padding:4px 0; margin:0px;color:#fff;">
            ...
            <div class="row">
                ...
                <div class="col-4 ps-5" style="margin-top:60px;">
                    <p style="color: #FF0000; font-weight: 500; font-size:14px; text-transform:uppercase;"> {{ __('messages.Terms_&_conditions') }} </p>
