    ...
    <div class="page">
        ...
        <section class=" first_section">
            <div class="row" >
                ...
                <div class="col-7 ">
                    <div class="w-75 ps-5 ">
                        <h5 class="p-0 m-0 fs-4 text-gray mt-3">  {{ __('messages.To_send') }}</h5>
            ...
            <div class="row">
                <div class="col-12 ps-5 ">
                    <table class="table ps-5 p-0 m-0">
                        <tr style="border-top:1px solid #202D58; border-bottom:1px solid #202D58;">
        ...
        <div class="row">
            ...
            <div class="col-6 ps-5 mt-5">
                <h3 style="color:#202D58; font-size:18.99px;">{{ __('messages.Thank_You_for_your_business') }}</h3>
            </div>
            <div class="col-6 pe-5" style="margin-top:20px; border-left:2px solid #202D58;">
                <p style="color: #FCB21C; font-weight: 500; font-size:14px; text-transform:uppercase;"> {{ __('messages.Terms_&_conditions') }} </p>
                <span style="color: #202D58; font-size: 14px;">{{ $userLogoAndTerms->terms }}</span>
             </div>
        </div>
    </div>
    </div>
