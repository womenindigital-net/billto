<body>
    ...
    <div class="page  "
        style="  background-image:  url('{{ asset('assets/vector-invoice/vector12.png') }}'); background-repeat: no-repeat;">
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        <div class=" me-1 text-end pe-5">
                            ...
                            @endif
                            <h1 style="color: #FF0000; font-size:59.99px;">{{ __('messages.INVOICE') }}</h1>
                        </div>
                    </div>
                    <div class="col-6 ">
