...
<body>
    ...
    <div class="invoice_body " style="background: url('assets/vector-invoice/vector15.png') no-repeat scroll;">
        ...
        <section class="second_section">
            ...
            <div class="invoice_form_to">
                ...
                <p style="border-bottom:2px solid #CBF1FF; padding:0px; margin:0px; width:70%;"></p>
        ...
        <section class="third_section_product_details">
            ...
            <div class="product_details" style="  margin-top:30px;">
                <table class="product_derails_table" style="width:100%; border:none;">
                    <thead>
                        <tr style="">
                            <th
                                style=" border-collapse: collapse; background-color: #CBF1FF;  width:20%;  font-size: 17px; text-transform: uppercase; padding-left:5px; color: #686868; text-align:left; ">
                                {{ __('messages.qty') }} </th>
                            <th
                                style="  border-collapse: collapse; border-top:none; background:#CBF1FF; border-right:none; padding-left:10px; text-align:left; width:40%; font-size: 17px; line-height: 29px;text-transform: uppercase; color: #686868;">
                                {{ __('messages.description') }} </th>
                            <th
                                style="  border-collapse: collapse; border-top:none; background:#CBF1FF;  border-right:none; padding-right:20px; text-align:right; width:20%; font-size: 17px; line-height: 29px;text-transform: uppercase; color: #686868;">
                ...
                <div class="subtotal_section ">
                    <p style="border-bottom:1px solid #0072BC; padding:0; margin:0px; margin-top:30px;"> &nbsp;</p>
            ...
            <div class="total_amount_title_total_amount_amount " style="margin-left:30px;">
                <div class="total_amount_title">
                    <h5 style="font-size:16px; padding:5px 20px 5px 0px; margin:0px; background:#0072BC; ">
                        {{ __('messages.Total') }}</h5>
                </div>
                <div class="total_amount_amount">
                    <h5 style="font-size:16px;  padding:5px 39px 5px 0px; margin:0px; background:#0072BC; ">
        ...
        <section class="forth_section_thankyou">
            <div>
                <h5 style=" color: #686868; font-weight: 400; font-size: 30px; width: 100%;text-align:center; margin-top:70px; ">
