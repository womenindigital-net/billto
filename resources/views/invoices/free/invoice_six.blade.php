    ...
    <div class="invoice_body" style="">
        ...
        <div class="second_section_invoice_to_date">
            <div class="section_invoice_to">
                ...
                <p style="border-bottom:2px solid #FCB21C; padding:2px 0px; margin:0px; width:70%;"></p>
                <p style="color:#686868;text-weight:bold; padding:2px 0; margin:0px; ">{{ $invoiceData->invoice_to }}</p>
            </div>
        </div>
                    ...
                    <table class="product_derails_table" style="width:100%; border:none;">
                        <thead>
                            <tr style="">
                                ...
                                <th
                                    style="  border-collapse: collapse; border-top:none;background: #FCB21C;  border-right:none; padding-right:20px; text-align:right; width:20%; font-size: 17px; line-height: 29px;text-transform: uppercase; color: #686868;">
                        ...
                        <tbody>
                            ...
                            @foreach ($productsDatas as $product_detail)
                                <tr>
                                    ...
                                    <td
                                        style="border-collapse: collapse;   padding-right:20px; width:20%; font-weight: 400; font-size: 16px; color: #686868; text-align:right; background: #FCB21C;">
                            ...
                            @for ($x = $last_count; $x <= 5; $x++)
                                <tr>
                                    ...
                                    <td
                                        style="border-collapse: collapse;  padding-right:20px; width:20%;  font-size: 16px; color: #686868; text-align:right; background: #FCB21C;">
                                    </td>
                                </tr>
                            @endfor
                        </tbody>
     ...
     .third_section_right_side {
                ...
                <div class="subtotal_section ">
                    <div style=" width:100%; display:flex;">
                        <div class="col_60">
                            ...
                            <p style="padding: 4px 0; margin:0px;"> {{ __('messages.Sales_Tax') }} ({{ $tax = $invoiceData->invoice_tax_percent }}%)</p>
                            <p style="padding: 4px 0; margin:0px;">{{ __('messages.Discount_Amount') }} ({{ $tax = $invoiceData->discount_percent }}%)</p>
                            <p style="padding: 4px 0; margin:0px;">{{ __('messages.Receive_Advance_Amount') }} ({{ $invoiceData->currency }})</p>
                            <p style="padding: 4px 0; margin:0px;">{{ __('messages.Requesting_Advance_Amount') }}({{ $invoiceData->requesting_advance_amount_percent }}%)
                            </p>
                            <h5 style="font-size:16px;  margin:0px; color:#FFFFFF">
                                {{ __('messages.Total') }} ({{ $invoiceData->currency }})</h5>
                        </div>
                        <div class="col_40">
                            <p style="padding: 4px 0; margin:0px;">{{ number_format($subtotal = $invoiceData->subtotal_no_vat, 2) }}</p>
                            <p style="padding: 4px 0; margin:0px;"> {{ number_format($tax_value = ($subtotal * $tax) / 100, 2) }}</p>
                            <p style="padding:4px 0; margin:0px;">{{ number_format($invoiceData->discount_amounts, 2) }}</p>
                            <p style="padding:4px 0; margin:0px;">{{ number_format($invoiceData->receive_advance_amount, 2) }}</p>
                            <p style="padding: 4px 0; margin:0px;">{{ number_format(($invoiceData->final_total * $invoiceData->requesting_advance_amount_percent) / 100, 2) }}
                            </p>
                            <h5 style="font-size:16px;   margin:0px; color:#FFFFFF ">
        ...
        <section class="forth_section_thankyou">
            ...
            <div class="third_section_left_side">
                <p style="font-size: 16px; font-weight:blod; text-transform: uppercase; padding:0px; margin:0px; color:#FCB21C; margin-top:50px;">
