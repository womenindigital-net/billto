    ...
    <div class="invoice_body" style="">
            ...
            <div class="subtotal_section ">
                <div style=" width:100%; display:flex;">
                    ...
                    <div class="col_40">
                        ...
                        <p style="padding:4px 0; margin:0px;">{{ number_format($invoiceData->discount_amounts, 2) }}
                        </p>
                        <p style="padding:4px 0; margin:0px;">
        ...
        <section class="forth_section_thankyou">
            ...
            <div class="third_section_left_side">
                <p
                    style="font-size: 16px; font-weight:blod; text-transform: uppercase; padding:0px; margin:0px; color:#FCB21C; margin-top:50px;">
