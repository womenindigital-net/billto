    ...
    <div class="custom_border_lr">
        ...
        <section class=" first_section">
            <div class="row " style="display:flex; width:100%;">
                <div class="col-5 border" style="width:40%; float: left;">
                    <div class="mt-4 ps-5 border" style="padding-left:20px;  padding-top:20px;">
        ...
        <div class="row" style="display:flex; width:100%;">
            ...
            <div style="width:40%; float:left; ">
                <h3 style="color:#202D58; font-size:18.99px; padding-left:30px; padding-top:80px; border-right:2px solid #202D58;">{{ __('messages.Thank_You_for_your_business') }}</h3>
            </div>
            <div style="margin-top:20px; width:48%; float:right; padding-left:10px; padding-right:30px;">
                <p style="color: #FCB21C; font-weight: 500; font-size:14px; text-transform:uppercase;">
                    {{ __('messages.Terms_&_conditions') }} </p>
                <span style="color: #202D58; font-size: 14px;">{{ $userInvoiceLogo->terms }}</span>
                <p style="color: #202D58; font-size: 14px;"> {{ $invoiceData->invoice_notes }}</p>
            </div>
        </div>
    </div>
</div>
