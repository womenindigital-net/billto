    ...
    <div class="invoice_body page">
        <section class="first_section">
            <div class="logo_area">
                @if ($userInvoiceLogo->invoice_logo != '')
                    <img class="logo_image" style="object-fit: contain; width:80px; height:80px;"
                        src="{{ public_path('storage/invoice/logo/' . $userInvoiceLogo->invoice_logo) }}" alt="img">
                @endif
                <p style=" font-size:16px; padding:12px;text-align: center; ">{{ $invoiceData->invoice_form }} </p>
            </div>
        ...
        <section class="second_section">
                    ...
                    <table class="table1" style="width:100%;   border-collapse: collapse;">
                        ...
                        <tbody>
                            ...
                            @for ($x = $last_count; $x <= 5; $x++)
                                <tr>
                                    <td style=" padding:6px 0px; text-align:left; width:15%; border-bottom: 1px solid #C4C4C4;  font-size: 16px; color: #686868; ">
                                        &nbsp;
                                    </td>
                                    <td
                                        style=" text-align:left; width:45%;border-bottom: 1px solid #C4C4C4; font-size: 16px; color: #686868; ">
            ...
            <div style="margin-left:300px; margin-top:80px;">
                <table style="width: 100%;  border-top:2px solid #197B30;margin-right:50px; ">
        ...
        <section class="third_section">
            <div class="left_Side_bar" style=" background-color: #197B30">
                <div class="third_sectionc">
                    <h5>{{ __('messages.To_send') }}</h5>
                    <div class="border"></div>
                    <p style="padding:12px;text-align: center; font-size:16px;">{{ $invoiceData->invoice_to }}</p>
                </div>
            </div>
            <div class="right_Side_bar">
                ...
                <div class="last_section">
                    <div class="left_terms_condition">
                        <p style="font-size: 16px; color: #197B30; text-transform: uppercase;">
