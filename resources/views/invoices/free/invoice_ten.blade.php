...
<body>
    ...
    <div class="invoice_body " style="background: url('assets/vector-invoice/vector10.png') no-repeat scroll;">
            ...
            <div class="invoice_date_details">
                <table style="width:100%;">
                    <tr>
                        ...
                        <td
                            style="text-align: right; font-size:16px; color:#FFFFFF; padding-top:7px; padding-bottom:7px;">
            ...
            <div class="product_details" style="">
                <table class="product_derails_table" style="width:100%; border:none;">
                    <thead>
                        <tr style="">
                            <th
                                style=" border-collapse: collapse; background-color: #ED1C24;  width:20%;  font-size: 17px; text-transform: uppercase; padding-left:5px; color: #fff; text-align:left; ">
                                {{ __('messages.qty') }} </th>
                            <th
                                style="  border-collapse: collapse; border-top:none; background:#ED1C24; border-right:none; padding-left:10px; text-align:left; width:48.9%; font-size: 17px; line-height: 29px;text-transform: uppercase; color: #fff;">
        ...
        <section class="forth_section_thankyou">
            ...
            <div class="third_section_right_side">
                <p style="font-size: 14px; text-transform: uppercase; padding:0px; margin:0px; color:#ffffff;">
                    {{ __('messages.Terms_&_conditions') }}</p>
                <p style="  padding:0px; margin:0px; line-height:20px; color:#ffffff;">{{ $userInvoiceLogo->terms }}
                </p>
                <p style="  padding:0px; margin:0px; color:#ffffff;">{{ $invoiceData->invoice_notes }} </p>
            </div>
