...
<body>
    ...
    <div class="invoice_body " style="background: url('assets/vector-invoice/Invoice11.png') no-repeat scroll;">
        ...
        <section class="second_section">
            <div class="empty_div">
                ...
                <p style="border-bottom:2px solid #F49AC1; padding:0px; margin:0px; width:70%;"></p>
            ...
            <div class="product_details" style="">
                <table class="product_derails_table" style="width:100%; border:none;">
                    <thead>
                        <tr style="">
                            <th
                                style=" border-collapse: collapse; background-color: #F49AC1;  width:20%;  font-size: 17px; text-transform: uppercase; padding-left:5px; color: #fff; text-align:left; ">
                                {{ __('messages.qty') }} </th>
                            <th
                                style="  border-collapse: collapse; border-top:none; background:#F49AC1; border-right:none; padding-left:10px; text-align:left; width:48.9%; font-size: 17px; line-height: 29px;text-transform: uppercase; color: #fff;">
