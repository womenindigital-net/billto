...
<body>
    ...
    <div class="invoice_body " style="background: url('assets/vector-invoice/vector12.png') no-repeat scroll;">
                ...
                <div class="i_title">
                    @if ($invoiceData->invoice_logo != '')
                        <img class="logo_image" style="width:100px; height:100px; object-fit: contain;"
                            ...
                            alt="img">
                    @endif
                    <h1 style="padding: 0px; margin:0px; color:#FF0000;  font-wieght:bold;">{{ __('messages.INVOICE') }}</h1>
                </div>

                <table style="width:100%;  margin-right:10px; padding-top:15px; padding-bottom:40px;">
                    <tr>
                        <td style=""></td>
                        ...
                        <table class="table1 " style="width:100%;">
                            <thead>
                                <tr style="padding-left:200px !important;">
                                    <th
                                        style=" border-collapse: collapse; background-color: #197B30;  width:20%;  font-size: 17px; text-transform: uppercase; padding-left:5px; color: #fff; text-align:left; ">
                                        {{ __('messages.qty') }} </th>
                                    <th
                                        style="  border-collapse: collapse; border-top:none; background:#197B30; border-right:none; padding-left:10px; text-align:left; width:40%; font-size: 17px; line-height: 29px;text-transform: uppercase; color: #fff;">
                                        {{ __('messages.description') }} </th>
                                    <th
                                        style="  border-collapse: collapse; border-top:none; background:#197B30;  border-right:none; padding-right:20px; text-align:right; width:20%; font-size: 17px; line-height: 29px;text-transform: uppercase; color: #fff;">
        ...
        <section class="third_section">
            <div style="padding-top:20px; padding-left:56px;">
            ...
            <div class="third_section_right_side">
                ...
                <img style="object-fit:contain;" style="width: 80px; height:80px;margin-top:35px; "
