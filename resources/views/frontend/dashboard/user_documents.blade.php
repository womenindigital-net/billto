        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 m-0 p-0 mt-1">
                <div class="container-fluid  side-bar_left   overflow_scroll mt-1 ">
                    ...
                    @endforeach
                    <form action="{{ url('/user-document/store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="document_type_id" id="" class="form-control" >
                                                ...
                                                @foreach ($documents as $document)
                                                    <option value="{{ $document->id }}">{{ $document->document_type }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <tbody>
                                        @foreach ($join_table_value as $key => $document_type)
                                            <tr class="m-0 p-0">
                                                ...
                                                <td class="m-0  "><img
                                                        src="{{ asset('uploads/document/' . $document_type->document_image) }}"
                                                        alt="" style="width:100px; height:80px;"> </td>
                                                <td class="m-0 text-center ">
                                                    <a href="{{ url('/document/view/' . $document_type->id) }}"
                                                        class=" btn btn-sm btn_view send_view_btn"><i
                                                            class="bi bi-eye "></i></a>
                                                    <a href="{{ url('/document/edit/' . $document_type->id) }}"
                                                        class=" btn btn-sm btn_view send_view_btn"><i
                                                            class="bi bi-pencil"></i></a>
                                                    <a href="{{ url('/document/delete/' . $document_type->id) }}"
                                                        class=" btn btn-sm btn_view send_view_btn"><i
