                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="d-flex ">
                                        ...
                                        <select class="tk w-50 fw-bolder form-select form-select-sm" name="currency"
                                            id="currencyList" onchange="currency1()">
...
@endif
                        ...
                        <div class="col-md-5" style="display: grid">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="invoice_payment_term" class="form-control"
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="invoice_po_number" class="form-control"
                        ...
                        <div class="text-start p-0 pe-1 pb-2 col-md-2">
                            <div class="input-group">
                                <input type="number" name="product_rate" id="product_rate" class="form-control"
                                    placeholder="Rate" onchange="ptotal();addData();">
...
@endif
                ...
                <div class="col input-group p-0">
                  ...
                  <div id="advance_amount_error" class="invalid-feedback"></div>
                                ...
                                <div class="row pt-2 ">
                                    <div class="col-7 d-flex align-items-center"><label for="#advance_amount">Requesting
                                ...
                                <div class="row pt-2">
                                    <div class="col-7 d-flex align-items-center fw-bolder text-dark">Requesting Advance
                                        Amount </div>
                                    <div class="col d-flex justify-content-end input-group border-bottom rounded p-0">
                                ...
                                <div class="row pt-2 ">
                                    ...
                                    <div class="col input-group p-0">
                                        <input type="number" name="receive_advance_amount" class="form-control"
                                            role="button" aria-disabled="true" value=""
                                            id="receive_advance_amount" disabled onchange="">
                                        <div class="input-group-text" id="currency">USD</div>
